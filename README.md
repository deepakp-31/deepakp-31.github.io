...
- **Frameworks**: ROS, ROS2 (Services, Actions, MoveIt, MoveBase, Custom Planners – A*, RRT/RRT*, MAVlink)
...
- Supported R&D by refining NVIDIA Isaac ROS path planning frameworks for surveillance and space exploration.

### Robotics Engineer – Bosch Global Software Technologies, Bangalore  
**February 2022 – July 2024**
- Explored MoveIt for motion planning and integrated 3D navigation for indoor micro-drone prototypes. Validated available packages in simulation.
...
- Designed and developed simulation models and optimized path planning algorithms for bulldozer robotics, enhancing performance and safety, with successful deployment in international construction markets.
...
- Managed data for EC2 servers and automated SQL database maintenance tasks on AWS.
...
### Quadruped Robot
- Designed and developed a quadruped robot prototype using open-source tools and components.
...
- Represented the company at ROSCon 2025, driving market outreach and strategic collaborations.
